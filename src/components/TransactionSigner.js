      ...
      content = <div className="so-back">
        <div className="so-chunk">
          <div className="TxSignerImport TransactionSigner__import">
            <p className="TxSignerImport__title">输入一个XDR格式的“事务“信封:</p>
      ...
      <div className="so-back">
        <div className="so-chunk">
          <div className="pageIntro">
            <p>事务签名器可以让你在OSChain“事务”添加一个签名,OSChain网络中私钥签名可以证明公钥匙账户授权了“事务”中的操作。</p>
            <p>对于简单的”事务“，一般仅仅需要一个正确的账户签名，如果“事务”中含有多个源账户和一些高级账户（有多个子私钥）签名等，将需要多个签名。</p>
          </div>
        </div>
      </div>
      {content}
